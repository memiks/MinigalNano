    ...
    function sortContent(content) {
        ...
        if (href.match(/\.(jpeg|jpg|gif|png)/)) {
            ...
            if(image.alt.length > 0) {
                ...
                spanalt.textContent = image.alt;
                spanalt.className = 'lightbox-text-alt'; 
        ...
        if (href.match(/\.(mp4|mov|avi)/)) {
            video = document.createElement('video');
            video.className = 'lightbox-video';
            video.src = href;
            video.controls = 1;
            video.autoplay = 1;
            video.alt = content.getAttribute('data-image-alt');
            video.wrapper = document.createElement('div');
            video.wrapper.className = 'lightbox-video-html';
